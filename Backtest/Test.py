...
strategy = strategy_DualMA(dh, start_time = start_time_backtest,
                           end_time = end_time_backtest, trading_symbols = trading_symbols,
                           account = account, long_term = 10, short_term = 5, quantity = 10)

# strategy = strategy_DualThrust(dh, start_time = start_time_backtest,
#                                end_time = end_time_backtest, trading_symbols = trading_symbols,
#                                account = account, n1 = 20, n2 = 10, k1 = 0.2, k2 = 0.2, quantity = 10)

# strategy = strategy_R_Breaker(dh, start_time = start_time_backtest,
#                               end_time = end_time_backtest, trading_symbols = trading_symbols,
